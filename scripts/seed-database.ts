...
async function main() {
  ...
  // ========================================
  // 1. CREATE BRANCHES FIRST (required by users)
  // ========================================
  ...
  // ========================================
  // 2. CREATE USERS (now branches exist)
  // ========================================
  ...
  // ========================================
  // 6. CREATE RECIPES (skipped for initial seed - optional)
  // ========================================
  console.log('📝 Skipping recipe creation (can be added later)...\n')
