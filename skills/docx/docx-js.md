...
Use `new PageBreak()` at the start of the next section to ensure TOC is isolated.
...
- **Page break**: Use `new PageBreak()` at the start of the next section to ensure cover is isolated
