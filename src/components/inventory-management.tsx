          ...
          <div className="space-y-3">
            <div className="space-y-2">
              ...
              <select
                ...
                className="w-full border border-slate-200 dark:border-slate-700 rounded-md px-3 py-2"
              >
